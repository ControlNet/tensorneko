...
class Trainer(PLTrainer):
    """
    The Trainer wrapper follows the Trainer in PyTorch Lightning, but with some modification in logger, checkpoint,
    and callbacks.

    Please use :meth:`Trainer.build` to instantiate a Trainer object.

    We use two TensorBoard for training and validation respectively, for better visual effects in TensorBoard
    ...
    def build(
        ...
        Returns:
            :class:`~.Trainer`: A Trainer object.
